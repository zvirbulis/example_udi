<template>
    ...
    >
                ...
                <div class="tools-buttons">
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <b-dropdown-item v-html="action.name" v-for="(action, actionIndex) in grid.actions" :href="action.link" :key="action.code" @click="clickAction(actionIndex)">
                            </b-dropdown-item>
        ...
        <confirm-action v-if="isShowedConfirmAction"
                        :title="'Увага!'"
                        :message="messageConfirmAction"
                        :question="questionConfirmAction"
                        :expected_answer="expectedAnswerConfirmAction"
                        v-on:action="actionConfirmAction"
                        v-on:hide="hideConfirmAction"
        ></confirm-action>
	</div>
</template>
